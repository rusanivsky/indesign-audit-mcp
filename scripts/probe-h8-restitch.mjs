...
const script = await readFile(new URL("./probe-h8-restitch.jsx", import.meta.url), "utf8");
const r = await runJsx("run_script", { script, undoName: "Зонд H8-2: перезшивання" }, { timeoutMs: 300_000 });
