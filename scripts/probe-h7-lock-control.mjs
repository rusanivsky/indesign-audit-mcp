...
const script = await readFile(new URL("./probe-h7-lock-control.jsx", import.meta.url), "utf8");
const r = await runJsx("run_script", { script, undoName: "Контроль 19: замок проти геометрії" }, { timeoutMs: 180_000 });
